...
/**
 * CategoryManagementSearch represents the model behind the search form of `backend\models\CategoryManagement`.
 */
class CategoryManagementSearch extends CategoryManagement
{
    ...
    public function rules()
    {
        return [
            [['auto_id'], 'integer'],
            [['category_name', 'status', 'created_at', 'updated_at','category_image'], 'safe'],
        ];
    }
