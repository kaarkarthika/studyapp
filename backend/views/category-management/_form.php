...
<div class="box box-primary">
  ...
  <?php
                                ...
                                if($model->category_image!=""){
                                    $no = "yes";
                                    $user_image_url = url::base(true)."/".$model->category_image; 
                                    // $user_image_url = $model->imageUrl; 
                                }
                                if($user_image_url!=""){
                                        $prevIng = ' <span style="color:green;" >Update Image : '.$user_image_url.'</span>';
                                    }
                                // echo "<prE>";print_r($user_image_url);die;
                            ?>
                           
                            <div class='col-sm-6 form-group' >
                             <label>Image</label>
                              <input type="file" id="input-file-now-custom-1" class="dropify" name="CategoryManagement[category_image]" data-default-file="<?php echo $user_image_url; ?>" data-height="290" /><br />
                            </div>
                          </div>
        <div class="row">
