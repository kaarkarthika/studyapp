    ...
    <div class="box box-primary  ">
        ...
        <h3 class="box-title pull-left " ><?= Html::encode($this->title) ?></h3>
                <div class=" pull-right">
                    <?= Html::a('Add Video', ['videocreate'], ['class' => 'btn btn-default btn-sm']) ?>
                </div>
    </div>
   
<div class=" box-body min-height-table" style="overflow:auto;">
<?php Pjax::begin(); ?>    <?= GridView::widget([
        ...
        'columns' => [
              ...
              // 'headerOptions' => ['class' => 'actionPartnername'],
               'value' => function ($data) {
                   $options = array_merge([
                                            ...
                                            'data-toggle'=>'tooltip',
                                            'title' => Yii::t('yii', 'upload_video'),
                                            'aria-label' => Yii::t('yii', 'upload_video'),
                                            'data-pjax' => '0',
                                        ]);
                   $url=Url::base().'/'.$data->upload_video; 
                                        return Html::a('<span class="fa fa-file-video-o"> Video </span>', $url, $options);
          ...
          ['class' => 'yii\grid\ActionColumn',
               ...
               'template'=>'{videoview}{videoupdate}{delete}',
                            'buttons'=>[
                              'videoview' => function ($url, $model, $key) {
                               
                                   // return Html::a('<span class="glyphicon glyphicon-eye-open"></span>', $url, $options);
                                   return Html::button('<i class="glyphicon glyphicon-eye-open"></i>', ['value' => $url, 'style'=>'margin-right:4px;','class' => 'btn btn-primary btn-xs view view gridbtncustom modalView', 'data-toggle'=>'tooltip', 'title' =>'View' ]);
                                }, 
                             'videoupdate' => function ($url, $model, $key) {
                                        $options = array_merge([
